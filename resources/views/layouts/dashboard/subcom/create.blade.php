...
<div id="qw">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="mb-25">
                    <a href="#">উপকমিটি যুক্ত করুন</a>
                    <a href="{{ route('sub-committe.index') }}" class="btn btn-default btn-rounded print pull-right">Back</a>
            ...
            <div class="row1">
                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        ...
                        <select name="" class="form-control" id="subcom_id">
