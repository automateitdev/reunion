...
<div id="qw">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="mb-25">
                    <a href="#">শাখা কমিটি যুক্ত করুন</a>
                    <a href="{{ route('branch-committe.index') }}" class="btn btn-default btn-rounded print pull-right">Back</a>
            ...
            <div class="row">
                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        <label for="" class="form-label">শাখা কমিটি নির্বাচন করুন</label>
                        <select name="" class="form-control" id="branch_id">
                            <option value="">একটি নির্বাচন করুন</option>
                            @foreach($branchlists as $item)
